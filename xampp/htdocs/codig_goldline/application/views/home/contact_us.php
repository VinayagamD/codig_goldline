...
<div class="container ">
    ...
    <div class="row card">
        ...
        <form class="col s12 card-content" method="post" action="<?= base_url()?>save-enquiry">
            <div class="row">
            ...
            <div class="row">
                <div class="col s12 right-align">
                    <input type="submit" class="btn-large btn waves-effect waves-light #6a1b9a purple darken-3 "   value="Submit"/>
                </div>
            </div>
        </form>
