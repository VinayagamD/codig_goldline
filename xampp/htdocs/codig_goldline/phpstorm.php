 ...
 * @property CI_DB_mysql_driver|CI_DB_query_builder $db                                  This is the platform-independent layout Query Builder implementation class
 ...
 * @property CI_Hooks            $hooks                               Provides a mechanism to extend the layout system without hacking
